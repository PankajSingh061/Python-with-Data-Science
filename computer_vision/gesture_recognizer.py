...
import time
import cv2
path='F:\Python with Data Science\computer_vision\gesture_recognizer.task'
...
with GestureRecognizer.create_from_options(options) as recognizer:
    ...
    while cam.isOpened():
        ...
        if results:
            ...
            if gesture:
                cv2.putText(image,f'{hand}-{gesture}',(40,h-40),cv2.FONT_HERSHEY_COMPLEX,1,(0,255,255),1)
            index_pos=None
